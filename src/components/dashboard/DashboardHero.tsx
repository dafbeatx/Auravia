...
export function DashboardHero({ onCreateClick }: DashboardHeroProps) {
  return (
    <section
    ...
    >
      <div className="max-w-2xl space-y-3">
        ...
        <p className="text-xs sm:text-sm text-text-muted leading-relaxed font-sans pt-1">
          Buat, sesuaikan, dan publikasikan undangan Anda dalam satu tempat.
        </p>
        ...
        <div className="pt-4 flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary-hover text-primary-foreground text-xs sm:text-sm font-semibold rounded-lg shadow-xs transition-colors cursor-pointer focus-visible:outline-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
